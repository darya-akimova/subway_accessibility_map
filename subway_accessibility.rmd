...
All of the distributions for both types of stations are right skewed, with Manhattan having the longest tail, which means that there is a small number of neighborhoods with high counts. The heavy distribution towards zero, such as the Bronx data in either plot, 
