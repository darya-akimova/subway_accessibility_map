...
nyc.neigh.count.prep %>%
  ggplot() +
  geom_sf(aes(fill = tot_stat)) +
  scale_fill_viridis_c(option = "A", name = "Total Stations") +
...
nyc.neigh.count.prep %>% 
  ...
  scale_fill_viridis_c(option = "A", name = "ADA stations") +
  geom_sf(data = nyc.parks.air.sf, fill =  "grey30") +
  theme(axis.text.x = element_blank(), axis.text.y = element_blank())
...
nyc.neigh.count.prep$ada_per_breaks <- cut(nyc.neigh.count.prep$ada_percent, breaks = seq(0, 100, 20))

nyc.neigh.count.prep %>% 
  ggplot() +
  geom_sf(aes(fill = ada_per_breaks)) +
  scale_fill_manual(values = c("#c7e9b4", "#7fcdbb", "#41b6c4", "#2c7fb8", "#253494"), na.value = "gray50", name = "Percent ADA") + 
  geom_sf(data = nyc.neigh.notada, fill = "darkgoldenrod") +
  geom_sf(data = nyc.parks.air.sf, fill = "grey30") +
  theme(axis.text.x = element_blank(), axis.text.y = element_blank())
summary(nyc.neigh.count.prep$ada_percent)
```
...
nyc.4boro.buff.join %>% 
  ...
  geom_sf(data = nyc.neigh.4boro, color = "white", size = 1, fill = NA) +
